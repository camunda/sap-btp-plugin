...
!(function (e, t) {
  ...
  var w = (function () {
      ...
      return (
        ...
        (t.heading = function (e) {
          ...
          if (e)
            return (
              (t = e[2].trim()),
              /#$/.test(t) && ((u = k(t, "#")), (!this.options.pedantic && u && !/ $/.test(u)) || (t = u.trim())),
              (u = { type: "heading", raw: e[0], depth: e[1].length, text: t, tokens: [] }),
        ...
        (t.blockquote = function (e) {
          ...
          if (e)
            return (
              (t = e[0].replace(/^ *>[ \t]?/gm, "")),
              { type: "blockquote", raw: e[0], tokens: this.lexer.blockTokens(t, []), text: t }
            )
        }),
        (t.list = function (e) {
        ...
        (t.text = function (e) {
          ...
          if (e)
            return (e = { type: "text", raw: e[0], text: e[0], tokens: [] }), this.lexer.inline(e.text, e.tokens), e
        }),
        (t.escape = function (e) {
        ...
        (t.reflink = function (e, t) {
          ...
          if ((u = this.rules.inline.reflink.exec(e)) || (u = this.rules.inline.nolink.exec(e)))
            return (e = t[(e = (u[2] || u[1]).replace(/\s+/g, " ")).toLowerCase()]) && e.href
    ...
    v =
      ((y.def = p(y.def).replace("label", y._label).replace("title", y._title).getRegex()),
      (y.bullet = /(?:[*+-]|\d{1,9}[.)])/),
